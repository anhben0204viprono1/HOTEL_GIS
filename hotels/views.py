...
def hotel_list(request):
    hotels = Hotel.objects.filter(is_active=True).prefetch_related('amenities', 'room_types')
    ...
    context = {
        ...
        'filters': {'q': q, 'city': city, 'stars': stars, 'max_price': max_price, 'category': category_id},
        'total': hotels.count(),
    }
...
def hotel_detail(request, slug):
    ...
    hotel_geojson = json.dumps({
        ...
        "properties": {"name": hotel.name, "address": hotel.address}
    })
